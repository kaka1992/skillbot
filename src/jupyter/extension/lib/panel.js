...
class AgentPanel extends widgets_1.Widget {
    ...
    _makeSkillRow(s, selected) {
        ...
        row.innerHTML = `
      ${dot}
      <span style="color:${panelStyles_1.CC.text};font-size:12px;">${this._esc(s.name)}</span>
      <span style="color:${statusColor};font-size:10px;margin-left:auto;">${status}</span>
    `;
        return row;
    }
    _updateSkillSelection(skills) {
...
// ---- prompt -------------------------------------------------------------
AgentPanel.DISPLAY_COMMANDS = ['/clear', '/mode', '/skills'];
// ===========================================================================
// Plugin
// ===========================================================================
exports.panelPlugin = {
